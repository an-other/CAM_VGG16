...
#build datasets
DIR_TRAIN = "/content/CAM_VGG16/train/"
DIR_TEST = "/content/CAM_VGG16/test1/"
...
if PRETRAINED:
    ...
    net=VGG(feature,2)
    net.load_state_dict(torch.load('/content/drive/MyDrive/checkpoint/vgg16_bn1.pth'))   #input your pretrained net
